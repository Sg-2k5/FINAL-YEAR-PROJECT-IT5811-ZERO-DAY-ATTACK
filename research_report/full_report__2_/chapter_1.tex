...
\section{OBJECTIVES}
The primary objective of this project is to collect real-time system events for 
processes, files, and network connections to establish a comprehensive monitoring 
baseline. Building upon this data, the project aims to construct heterogeneous 
temporal graphs that capture the intricate behavioral relationships and 
interactions among various system entities.

A core focus involves training a self-supervised graph autoencoder to learn and 
model normal system behavior without the necessity for labeled attack data. This 
model serves as the foundation for detecting anomalies by utilizing a combination 
of reconstruction errors and structural features to identify deviations from the 
learned norm.


\section{SCOPE OF THE PROJECT}
This project develops a real-time host monitoring system utilizing behavioral graph construction and self-supervised graph autoencoding for hybrid anomaly detection. The scope includes validating the framework against simulated attack scenarios including reverse shells, privilege escalation,ransomware and data exfiltration and evaluating its efficacy through performance metrics and visual analysis.
...
\vspace{0.6em}
CHAPTER 4 SYSTEM IMPLEMENTATION describes the algorithms used.

\vspace{0.6em}
CHAPTER 5 RESULTS AND PERFORMANCE presents the results and the descriptive results of the study, including
an in-depth analysis of the various performance parameters.
\newline
\vspace{0.6em}
CHAPTER 6 concludes this work and describes the prospective future work in this area.
